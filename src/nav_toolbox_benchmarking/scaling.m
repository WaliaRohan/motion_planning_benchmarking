...
occMatrix = zeros(2160, 3840);
map_size = [177.778 100.000];

resolution = mean([size(occMatrix, 2)/map_size(1) ...
    size(occMatrix, 1)/map_size(2)]);

map = occupancyMap(occMatrix, resolution);
